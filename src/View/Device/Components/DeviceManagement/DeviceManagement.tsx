...
const InputText: React.FC<DeviceManagementProps> = ({ label, placeholder, type, width }) => {
    return (
    ...
    return (
        <div className="flex-1 mt-[106px] pl-6 flex flex-col gap-4">
            ...
            <div className="mt-3 w-full flex justify-center gap-8">
                ...
                <Button type="Hover" size="Normal" skin="Fill" icon="NoIcon" title="Thêm thiết bị" width="150px" />
            </div>
        </div>
    );
};
